...
import { addProblemToSheet, createSheet, deleteSheet, getAllSheets, getSheetById, getSheetsCount, removeProblemToSheet, updateSheet } from '../controllers/sheet.controller.js'
...
sheetRoute.get('/getSheetsCount', authMiddleware, getSheetsCount)
